  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-56">
        <DropdownMenuItem onClick={handleExportarProdutos}>
          <Package className="mr-2 h-4 w-4" />
          Relatório Completo de Produtos
        </DropdownMenuItem>
        <DropdownMenuItem onClick={handleExportarMovimentacoes}>
          <Activity className="mr-2 h-4 w-4" />
          Relatório de Movimentações
        </DropdownMenuItem>
        <DropdownMenuSeparator />
        <DropdownMenuItem onClick={handleExportarEstoqueBaixo}>
